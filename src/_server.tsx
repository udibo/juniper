...
/**
 * Configuration options for the React Router static handler and router on the server.
 * These options allow customization of basename and future flags to match client configuration.
 */
export interface ServerRouterOptions {
  /**
   * The base URL for the application.
   * Must match the client's basename for proper routing.
   */
  basename?: string;

  /**
   * Future flags for React Router v7 compatibility.
   * Should match the client's future configuration.
   */
